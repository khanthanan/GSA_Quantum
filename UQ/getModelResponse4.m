function modelResponse = getFullModelResponse4(theta, xdata, extra)
    % This model computes the probability of state |100>.

    [t1,t2,t3,t4,t5,t6,t7,t8,t9] = transfer(theta);
    
    f1tmp = (-sin(t5/2)*sin(t6/2)*sin(t2/2 + t4/2)*cos(t7/2 + t9/2) ...
